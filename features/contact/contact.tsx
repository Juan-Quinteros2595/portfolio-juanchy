          ...
          <div className="md:w-2/3 mb-12 md:mb-0">
            ...
            <motion.div variants={containerVariants} className={styles.infoContainer}>
              <motion.div variants={itemVariants} className={styles.infoRow}>
                <span className={styles.infoLabel}>{dictionary["contact.whatsapp"]}</span>
                <span itemProp="telephone">+3333333333</span>
              </motion.div>

              <motion.div variants={itemVariants} className={styles.infoRow}>
                <span className={styles.infoLabel}>{dictionary["contact.email"]}</span>
                <span itemProp="email">juanchyfilmaker@gmail.com</span>
              </motion.div>

              <motion.div variants={itemVariants} className={styles.infoRow}>
                <span className={styles.infoLabel}>{dictionary["contact.office"]}</span>
                <div className="flex flex-col">
                  <span itemProp="address">{dictionary["contact.location.argentina"]}</span>
                  <span itemProp="address">{dictionary["contact.location.spain"]}</span>
                </div>
              </motion.div>
