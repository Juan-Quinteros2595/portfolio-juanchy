...
import { ClientCard } from "@/components/cards/client-card/ClientCard"
import { useLanguage } from "@/context/language-context"
import CLIENTS from "@/config/clients"
import styles from "@/styles/happy-clients-slider.module.css"
    ...
    <section className={styles.section}>
      ...
      >
        <motion.div variants={itemVariants} className={styles.header}>
          <h2 className={styles.title}>{t("clients.number")}</h2>
          <h3 className={styles.subtitle}>{t("clients.title")}</h3>
          <p className={styles.description}>{t("clients.description")}</p>
        </motion.div>
